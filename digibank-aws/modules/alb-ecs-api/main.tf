...
[
   {
      ...
      "environment":[
         ...
         },
         {
            ...
            "value":"service.name=${var.OTEL_SERVICE_NAME},service.namespace=${var.OTEL_SERVICE_NAMESPACE}"
         },
         {
      ...
      "environment":[
         {
            ...
            "value":"https://${var.CNAO_TENANT_HOST}/data"
         },
         {
   ...
   {
      "image":"appdynamics/infraagent-cnao:latest",
      "name":"appd-infra",
      "networkMode":"awsvpc",
      "essential":true,
      "logConfiguration":{
